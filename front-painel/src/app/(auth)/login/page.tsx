        ...
        <aside className="relative flex flex-col justify-between gap-10 overflow-hidden bg-slate-950 px-8 py-10 text-white sm:px-10 lg:px-12">
          ...
          <div className="relative space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="max-w-md text-sm leading-6 text-slate-300 sm:text-base">
                O backend responde com JWT em cookie httpOnly, o Axios renova a
                sessão automaticamente e a tela já está preparada com Zod e
                React Hook Form.
              </p>
            </div>
          </div>
          ...
          <div className="relative grid gap-3 text-sm text-slate-300 sm:grid-cols-2">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
              <strong className="block text-white">JWT + Refresh</strong>
              <span className="mt-1 block leading-6">
                Sessão autenticada sem expor token no JavaScript.
              </span>
            </div>
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
              <strong className="block text-white">Validação Zod</strong>
              <span className="mt-1 block leading-6">
