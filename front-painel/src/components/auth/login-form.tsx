    ...
    <section className="rounded-3xl border border-slate-200 bg-white/95 p-8 shadow-[0_30px_90px_rgba(15,23,42,0.12)] backdrop-blur">
      <div className="mb-8 space-y-2">
        ...
        <p className="text-sm leading-6 text-slate-600">
          Use o e-mail e a senha cadastrados. O backend envia JWT em cookie
          httpOnly e o Axios renova a sessão automaticamente.
        </p>
      </div>
      ...
      <div className="mt-6 rounded-2xl border border-dashed border-slate-200 bg-slate-50 p-4 text-sm text-slate-600">
        Credenciais de teste: <span className="font-medium">admin@painel.com</span>{" "}
